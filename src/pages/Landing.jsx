...
const Landing = (props) => {
  return (
    <>
      <div className="h-screen w-full bg-green-800 text-white relative grid grid-cols-[20% 40% 40%] grid-rows-[80% 20%] items-end gap-x-2.5 overflow-hidden">
        ...
        <div className=" col-start-1 col-span-1 row-start-1 row-span-1">
          <p className="h-56 leading-[1em] text-[220px] relative bottom-[-100px]">Bring</p>
        </div>
        <div className="col-start-1 col-span-3 row-start-2 row-span-1 ">
          <p className="h-56 leading-[1em] text-[220px] overflow-hidden align-bottom relative">Nature Home</p>
        </div>
